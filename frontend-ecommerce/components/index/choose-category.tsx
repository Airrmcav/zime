        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 mt-5 pt-5">
            <div className="max-w-7xl py-1 mx-auto px-6 lg:px-8">
                ...
                <div className="text-left mb-5">
                    {/* Badge */}
                   <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-orange-600/10 via-blue-600/10 to-orange-600/10 border border-blue-200/50 rounded-full mb-3 backdrop-blur-sm">
...
<h1 className="text-5xl lg:text-5xl font-black text-gray-900 mb-3 leading-tight">
    <span className="block">Equipo de Protección e</span>
    <span className="block bg-gradient-to-r from-blue-600 via-orange-600 to-blue-600 bg-clip-text text-transparent animate-gradient">
