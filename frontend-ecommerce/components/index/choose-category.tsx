...
const ChooseCategory = () => {
  ...
  const isElectricCategory = (category: CategoryType) => {
    ...
    return (
      name.includes("material electrico") ||
      name.includes("luminarias") ||
      name.includes("eléctrico") ||
      name.includes("electricidad") ||
      name.includes("cables") ||
      desc.includes("material electrico") ||
      desc.includes("luminarias")
    );
  };
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 mt-5 pt-5">
      <div className="max-w-7xl py-1 mx-auto px-6 lg:px-8">
        {/* Header Section */}
        <div className="text-left mb-5">
          {/* Badge */}
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-linear-to-r from-blue-600/10 via-orange-600/10 to-blue-600/10 border border-blue-200/50 rounded-full mb-3 backdrop-blur-sm">
          ...
          <h1 className="text-5xl lg:text-5xl font-black text-gray-900 mb-3 leading-tight">
            ...
            <span className="block bg-linear-to-r from-orange-600 via-blue-500 to-orange-600 bg-clip-text text-transparent animate-linear">
              Equipos Eléctricos
            </span>
          </h1>
          ...
          <p className="text-xl lg:text-2xl text-gray-600 max-w-7xl  leading-relaxed font-light">
            ...
            <span className="font-semibold text-blue-700">
              luminarias industriales especializado
            </span>
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-32">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Preparando equipos de protección y luminarias industriales
            </p>
          </div>
        )}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg">
                    Explora por especialidad para encontrar exactamente lo que
                    necesitas
                  </p>
                </div>
              </div>
