...
import { useGetFeaturedProducts } from "@/api/ME/useGetFeaturedProductsMe";
...
const FeaturedProductsElectric = () => {
        ...
        <div className="text-left mb-6 lg:mb-0">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-400 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-white">
              Productos Destacados luminarias
            </span>
          </div>
          ...
          <p className="text-lg text-gray-600 max-w-4xl">
            Descubre luminarias, extensiones, conectores, contactos, apagadores
            y más, con la mejor calidad y seguridad para tus proyectos
            eléctricos.
          </p>
        </div>
...
export default FeaturedProductsElectric;
