      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Trabajamos con las marcas líderes mundiales en equipos de protección
            personal y luminarias industriales
          </p>
        </div>
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      (e.target as HTMLImageElement).src =
                        `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="40" viewBox="0 0 100 40"><rect width="100" height="40" fill="%23f3f4f6"/><text x="50" y="25" font-family="Arial" font-size="12" text-anchor="middle" fill="%236b7280">${brand.name}</text></svg>`;
                    }}
                  />
                </div>
