...
import { useGetFeaturedProducts } from "@/api/Oficina/UseGetFeaturedProductsOficina";
...
import { CheckCircle, XCircle, Star, Heart, ShoppingCart, Maximize2, ShieldCheck, MoveRight, Package, Briefcase } from "lucide-react";
import IconButton from "../icon-button";
import { useRouter } from "next/navigation";
import { useCart } from "@/hooks/use-cart";
import { useLovedProducts } from "@/hooks/use-loved-products";

const FeaturedProductsOficina = () => {
        ...
        <div className="max-w-7xl my-5 mx-auto sm:py-0 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between">
                <div className="text-left mb-6 lg:mb-0">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 rounded-full mb-4">
                        <Briefcase className="w-4 h-4 text-white" />
                        <span className="text-sm font-medium text-white">
                            Productos Destacados de Oficina
                        </span>
                    </div>
                    <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                        Equipo de Oficina Funcional
                    </h1>
                    <p className="text-lg text-gray-600 max-w-4xl">
                        Descubre escritorios, sillas ergonómicas, archiveros y todo lo necesario
                        para mantener tu espacio de trabajo organizado, cómodo y productivo.
                    </p>
                </div>
                <div className="flex justify-center w-full lg:w-auto">
                    <button className="bg-blue-600 flex gap-2 text-white px-6 py-3 rounded-2xl font-medium hover:bg-gray-700 transition">
                        Ver más productos
                        <MoveRight />
                    </button>
                </div>
...
export default FeaturedProductsOficina;
