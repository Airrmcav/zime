...
import { ChevronLeft, ChevronRight, Star, ShoppingCart, Eye, Heart, Zap, Shield, Award, Lightbulb, Package, ShieldCheck, Briefcase, Droplet } from 'lucide-react';
...
const CarouselText = () => {
    ...
    const slides = [
        {
            ...
            subtitle: 'Equipos de Protección Personal y Material Eléctrico',
            description: 'Somos expertos en seguridad industrial. Ofrecemos una amplia gama de equipos de protección personal (EPIs) y materiales eléctricos certificados para proteger a tus trabajadores y optimizar tus proyectos.',
        ...
        },
        {
            ...
            description: 'Encuentra cajas de cartón ideales para embalaje, almacenamiento y envíos. Diseñadas para proteger tus productos con calidad y durabilidad.',
        ...
        },
        {
            ...
            description: 'Descubre cascos, guantes, chalecos, lentes y más. Todo lo que necesitas para proteger a tu equipo en cualquier entorno laboral.',
        ...
        },
        {
            ...
            description: 'Encuentra escritorios, sillas, archiveros y todo lo necesario para mantener tu oficina cómoda y eficiente.',
        ...
        },
        {
            ...
            description: 'Encuentra detergentes, desinfectantes, paños, escobas y todo lo necesario para mantener tus espacios limpios y saludables.',
            buttonText: 'Ver Productos',
    ...
    return (
        <div className="relative w-full h-96 md:h-[600px] overflow-hidden bg-gray-900 shadow-2xl"
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                                    ...
                                    <div className="text-white space-y-4 md:space-y-6">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            {slide.icon}
                                            <span className={`${slide.badgeColor} px-3 py-1 rounded-full text-xs font-bold text-white uppercase tracking-wider animate-pulse`}>
                                                {slide.badge}
                                            </span>
                                        </div>
                                        ...
                                        <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 animate-fadeInUp delay-300">
                                            <Link href={slide.catalogoSlug} className="group bg-white text-gray-800 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-100 transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center space-x-2">
