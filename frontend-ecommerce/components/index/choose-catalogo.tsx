...
const ChooseCatalogo = () => {
    ...
    const isElectricCatalogo = (catalogo: any) => {
        ...
        return name.includes('eléctrico') || name.includes('electricidad') ||
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 pt-5">
            <div className="max-w-7xl py-1 mx-auto px-6 lg:px-8">
                {/* Header Section */}
                <div className="text-left mb-10">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-600/10 via-orange-600/10 to-blue-600/10 border border-blue-200/50 rounded-full mb-2 backdrop-blur-sm">
                ...
                {loading && (
                    <div className="flex flex-col items-center justify-center py-32">
                        ...
                        <p className="text-xl text-gray-700 font-medium mt-6">Cargando catálogos...</p>
                    </div>
                )}
                ...
                {error && (
                    <div className="text-center py-32">
                        <div className="bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-200 rounded-2xl p-12 max-w-lg mx-auto shadow-xl">
                            <h3 className="text-xl font-bold text-red-800 mb-3">Error al cargar catálogos</h3>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 text-lg">
                                        Explora nuestros catálogos para encontrar exactamente lo que necesitas
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <CarouselContent className="-ml-2 md:-ml-4">
                                {result.map((catalogo: any) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <Link href={`/catalogo/${catalogo.slug}`} className="block h-full">
                                                    ...
                                                    <CardContent className="p-0 h-full flex flex-col">
                                                        ...
                                                        <div className="px-6 pt-6 flex flex-col flex-grow">
                                                            ...
                                                            <p className="text-gray-600 text-sm line-clamp-3 mb-4 flex-grow max-h-[60px]">
                                                                {catalogo.descriptionCatalogo || 'Explora nuestra selección de productos en este catálogo especializado.'}
                                                            </p>
                                                        </div>
                                                    </CardContent>
                                                </Card>
