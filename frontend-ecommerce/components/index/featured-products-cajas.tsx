...
import { useGetFeaturedProducts } from "@/api/Cajas/UseGetFeaturedProductsCajas";
...
import { CheckCircle, XCircle, Star, Heart, ShoppingCart, Maximize2, ShieldCheck, MoveRight, Package } from "lucide-react";
import IconButton from "../icon-button";
import { useRouter } from "next/navigation";
import { useCart } from "@/hooks/use-cart";
import { useLovedProducts } from "@/hooks/use-loved-products";

const FeaturedProductsCajas = () => {
        ...
        <div className="max-w-7xl my-5 mx-auto sm:py-0 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between">
                <div className="text-left mb-6 lg:mb-0">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-700 rounded-full mb-4">
                        <Package className="w-4 h-4 text-white" />
                        <span className="text-sm font-medium text-white">
                            Productos Destacados en Cajas de Cartón
                        </span>
                    </div>
                    ...
                    <p className="text-lg text-gray-600 max-w-4xl">
                        Encuentra cajas de cartón de diferentes tamaños y resistencias, ideales para
                        empaque, almacenamiento y envío seguro de tus productos.
                    </p>
                </div>
                <div className="flex justify-center w-full lg:w-auto">
                    <button
                    onClick={() => router.push('/catalogo/cajas-de-carton')}
                     className="cursor-pointer bg-amber-700 flex gap-2 text-white px-6 py-3 rounded-2xl font-medium hover:bg-orange-600 transition">
                        Ver más productos
                        <MoveRight />
                    </button>
                </div>
...
export default FeaturedProductsCajas;
