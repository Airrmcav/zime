  ...
  return (
    ...
    >
      ...
      {!loading &&
        ...
        result.schema.attributes.catalogo &&
        result.schema.attributes.catalogo.enum &&
        result.schema.attributes.catalogo.enum.length > 0 && (
          <div className="space-y-1">
            <RadioGroup
              ...
              className="space-y-3"
            >
              {result.schema.attributes.catalogo.enum.map(
                (catalogName: string, index: number) => {
