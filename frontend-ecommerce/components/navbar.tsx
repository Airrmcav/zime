        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between text-sm font-normal">
            <div className="flex items-center space-x-2 mb-2 sm:mb-0">
              <span className="text-black font-normal text-center sm:text-left">
                ¡Envíos a todo México! Cotiza ahora
              </span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-auto">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              >
                <Heart
                  className={`w-6 h-6 ${lovedItems.length > 0 && "fill-red-300"}`}
                />
                Mis Favoritos
              </button>
            ...
            <div className="flex lg:hidden items-center space-x-4">
              ...
              >
                <Heart
                  className={`w-5 h-5 ${lovedItems.length > 0 && "fill-red-300"}`}
                />
              </button>
              <button
                onClick={() => router.push("/carrito")}
                                ...
                                <a>
                                  ...
                                  <div className="space-y-2 text-center">
                                    <p className="text-sm leading-relaxed text-orange-700 group-hover:text-orange-100 transition-colors">
                                      Explora nuestra línea completa de equipos
