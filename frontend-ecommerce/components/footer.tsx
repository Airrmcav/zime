...
const CatalogosFooterList = () => {
  ...
  if (loading)
    return <div className="text-sm text-gray-500">Cargando catálogos...</div>;
  if (error)
    return (
      <div className="text-sm text-red-500">Error al cargar catálogos</div>
    );
    ...
    <footer className="bg-gray-200 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-800 text-sm leading-relaxed">
              Tu socio confiable en equipos de protección personal y luminarias
              de alta calidad.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center">
                ...
                <span className="text-gray-800">+52 55 1007 0205</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            <h4 className="font-semibold mb-3 text-orange-500 text-sm">
              Certificaciones
            </h4>
