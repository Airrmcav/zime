  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn("absolute top-0 left-0 w-1 h-full", colors.accent)}
        ></div>
        ...
        <div className="p-4">
          <div className="grid grid-cols-12 gap-4 items-center">
            ...
            <div className="col-span-12 md:col-span-6 flex items-center space-x-4">
              ...
              <div
                className={cn(
                  "w-16 h-16 rounded-lg flex items-center justify-center border transition-colors",
                  colors.border,
            ...
            <div className="col-span-8 md:col-span-1 text-center">
              ...
              <div
                className={cn(
                  "font-bold text-lg",
                  isElectrical ? "text-blue-600" : "text-orange-600",
                )}
              >
        ...
        <div
          className={cn(
            "absolute inset-0 bg-gradient-to-r rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none",
            colors.gradient,
          )}
        ></div>
      </li>
