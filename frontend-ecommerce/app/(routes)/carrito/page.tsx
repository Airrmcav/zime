...
export default function Cart() {
  ...
  const hasElectricalItems = items.some(
    (item) => item.category?.slug === "luminarias",
  );
      ...
      <div className="max-w-7xl px-0 py-8 mx-auto sm:px-6 lg:px-0">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            <div
              className={`p-3 rounded-full ${hasElectricalItems ? "bg-blue-100" : "bg-orange-100"}`}
            >
              {hasElectricalItems ? (
            ...
            <h1
              className={`text-4xl font-bold ${hasElectricalItems ? "text-blue-900" : "text-gray-900"}`}
            >
              Carrito de Compras
            </h1>
          </div>
        ...
        {items.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-md">
              Descubre nuestro catálogo de equipos de protección personal y
              luminarias industriales de alta calidad
            </p>
            <Button
              size="lg"
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between text-xl font-bold text-gray-900">
                      <span>Total</span>
                      <span
                        className={`${hasElectricalItems ? "text-blue-600" : "text-orange-600"}`}
                      >
                    ...
                    <div className="mt-6 space-y-3 text-sm text-gray-600">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-blue-700">
                          Certificación eléctrica garantizada
                        </span>
                      </div>
                    </div>
                  </div>
