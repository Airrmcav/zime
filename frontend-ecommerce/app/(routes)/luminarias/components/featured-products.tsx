          ...
          >
            <div className="h-full flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col min-h-[220px]">
                <h2
                  className={`font-bold text-lg mb-2 line-clamp-2 transition-colors duration-200 min-h-[56px] flex items-start ${isMaterialElectrico(product) ? "text-blue-600" : "text-orange-600"}`}
                >
                  {product.productName}
                </h2>
                ...
                {product.price && product.price > 0.0 && (
                  <div className="mb-4">
                    <span
                      className={`text-2xl font-bold ${isMaterialElectrico(product) ? "text-blue-600" : "text-blue-600"}`}
                    >
