...
import { Shield, Zap, Star, Package, CheckCheckIcon, ShoppingCart, Activity, HardHat, MessageCircle } from "lucide-react"
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">
                                EPP y Material Eléctrico de calidad profesional
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 mb-6 text-white shadow-lg">
                            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold">¡Cotiza Fácil y Rápido!</h3>
                                        <p className="text-green-100">Envía tu lista directamente por WhatsApp</p>
                                    </div>
                                </div>
                                <button
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200">
                        <div className="text-center py-16 px-6">
                            ...
                            <p className="text-gray-600 max-w-md mx-auto mb-4">
                                Explora nuestro catálogo de equipo de protección personal
                                y material eléctrico para comenzar tu selección.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto mb-8">
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-600">Material y Herramientas</p>
                                </button>
                            </div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-gray-700 font-medium">
                                            {lovedItems.length} {lovedItems.length === 1 ? 'producto' : 'productos'}
                                        </span>
                                    </div>
                                    {/* Recordatorio sutil */}
                        ...
                        <div className="bg-gradient-to-br from-green-600 via-green-700 to-green-800 rounded-2xl p-8 text-white shadow-xl">
                            <div className="text-center max-w-2xl mx-auto">
                                ...
                                <p className="text-green-100 mb-8">
                                    Haz clic para enviar tu lista de productos directamente por WhatsApp.
                                    Recibirás precios competitivos y asesoría especializada en menos de 24 horas.
                                </p>
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-gray-500">
                        ...
                        <span className="text-green-600 font-medium ml-1">Cotizaciones rápidas por WhatsApp</span>
                    </p>
                </div>
            </div>
        </div>
