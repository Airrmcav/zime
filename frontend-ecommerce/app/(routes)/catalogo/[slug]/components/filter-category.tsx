...
const FilterCategory = (props: FiltersCategoryProps) => {
    ...
    useEffect(() => {
        if (result && Array.isArray(result)) {
            ...
            let currentCatalogSlug = Array.isArray(catalogSlug) ? catalogSlug[0] : catalogSlug;
            ...
            const filtered = result.filter(category => {
                ...
                return category && category.catalogo && 
    ...
    const sortedCategories = filteredCategories.length > 0 ? 
        [...filteredCategories].filter(a => a && a.categoryName).sort((a, b) => 
