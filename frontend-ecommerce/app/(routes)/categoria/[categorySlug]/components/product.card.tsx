...
const ProductCard = (props: ProductCardProps) => {
  ...
  return (
    <div className="relative p-0 transition-all cursor-pointer" onClick={() => handleCardClick(product)}>
            ...
            <div className="p-0 h-full flex flex-col">
              <div className="relative overflow-hidden bg-white h-52 flex items-center justify-center">
                ...
                <div className="absolute bottom-3 left-3">
                  <Badge className={`${isMaterialElectrico
              ...
              <div className="p-4 flex-1 flex flex-col min-h-[220px]">
                <h2 className={`font-bold text-lg mb-2 line-clamp-2  transition-colors duration-200 min-h-[56px] flex items-start ${isMaterialElectrico ? 'text-blue-600' : 'text-orange-600'
                  }`}>
                  {product.productName}
                </h2>
                ...
                {product.price && product.price > 0.00 && (
                  <div className="mb-4">
                    <span className={`text-2xl font-bold ${isMaterialElectrico ? 'text-blue-600' : 'text-blue-600'
                      }`}>
