        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              Somos especialistas en equipo de protección personal y luminarias
              LED, comprometidos con la seguridad y calidad en cada proyecto.
            </p>
            <div className="flex justify-center items-center gap-8 mt-12">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-semibold">Luminarias LED</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p className="text-lg">
                  Desde nuestros inicios, hemos sido pioneros en la distribución
                  de equipos de protección personal y luminarias LED de la más
                  alta calidad.
                </p>
                <p>
                  Nacimos con la visión de crear un entorno más seguro para
                  trabajadores y empresas, ofreciendo productos que cumplen con
                  los estándares internacionales más exigentes.
                </p>
                <p>
                  Con años de experiencia en el mercado, hemos logrado
                  posicionarnos como líderes en nuestro sector, siempre
                  manteniendo nuestro compromiso con la innovación y la
                  excelencia.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Los valores que nos guían en cada decisión y nos impulsan hacia la
              excelencia
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 leading-relaxed">
                Proveer equipos de protección personal y luminarias de la más
                alta calidad, garantizando la seguridad y bienestar de nuestros
            ...
            <div className="bg-green-50 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 leading-relaxed">
                Ser la empresa líder en México en la distribución de equipos de
                seguridad y luminarias, reconocida por nuestra innovación y
            ...
            <div className="bg-purple-50 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 leading-relaxed">
                Integridad, compromiso con la seguridad, innovación constante y
                servicio al cliente excepcional son los valores que nos definen
                como empresa.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nos distinguimos por nuestro compromiso con la calidad y la
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Productos certificados que cumplen con las normas
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Equipo de expertos dedicado a asesorarte y encontrar la mejor
                solución.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Logística eficiente para que recibas tus productos en tiempo
                récord.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Más de 15 años especializándose en seguridad industrial y
                luminarias.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600">
                Constantemente incorporamos las últimas tecnologías en nuestro
                catálogo.
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Trabajamos con las marcas líderes en el mercado para garantizar la
              máxima calidad
            </p>
          </div>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600">
              Y muchas marcas más reconocidas mundialmente por su calidad y
              innovación
            </p>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Dos líneas de productos especializadas para cubrir todas tus
              necesidades
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Ofrecemos una amplia gama de EPP certificado para garantizar la
                seguridad en cualquier entorno laboral.
              </p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-3xl font-bold text-gray-900">Luminarias</h3>
              </div>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Componentes eléctricos de alta calidad para instalaciones
